    ...
    return (
      <div className="container Example">
        ...
        <p>
          ...
          in the file <code>components/example/Example.jsx</code>. It looks like
          a JavaScript class named Example that has a method named named{" "}
          <span className="code-name">render</span>, which appears to written in
